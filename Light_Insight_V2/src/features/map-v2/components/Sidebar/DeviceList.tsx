import { Center, Group, Loader, Paper, ScrollArea, Select, Stack, Text, TextInput, Tooltip } from '@mantine/core';
        ...
        {isLoading ? (
          ...
          <Stack gap="xs">
            {filteredCameras.map((camera) => {
              ...
              const fullName = camera.name || camera.code || t('pages.maps.sidebar.unnamedCamera');
              ...
              return (
                <Tooltip.Floating
                  ...
                  offset={15}
                  withinPortal
                  styles={{ tooltip: { backgroundColor: '#ffffff', border: '1px solid rgba(0,0,0,0.1)', color: '#000000', fontSize: '12px', fontWeight: 500, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' } }}
                >
                  <Paper
                    p="xs"
                    radius="md"
