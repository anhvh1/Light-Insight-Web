import { EARTH_RADIUS_METERS, MIN_FOV_DEGREES, MAX_FOV_DEGREES, GEO_MARKER_BASE_ZOOM, GEO_MARKER_SCALE_FACTOR, GEO_MARKER_MIN_SCALE, GEO_MARKER_MAX_SCALE } from './constants';
